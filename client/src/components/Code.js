...
class Code extends React.Component {
    ...
    render() {
        return (
            <div id='main-div'>
                {this.state.video && <VideoModal modal={this.state.video} handleClose={this.handleClose} />}
                            ...
                            <div className='left-wrapper code-text-wrapper'>
                                <div className='code-text-scroll'>
                                    <div className='inner-code-text'>
                                        ...
                                        <p className='code-text'>An information over time application built as my capstone project for BCA</p>
                                        <ul>
                                            <li className='code-text'>Handles data from multiple senors on the farm and displays sensors that might be in critical ranges</li>
                                            <li className='code-text'>Notifies farm employees via text message when sensors are out of range</li>
                                            <li className='code-text'>Allows querying of data in any time range</li>
                                            <li className='code-text'>Time intervals of queries are determined by length of the time range</li>
                                            <li className='code-text'>Technologies: Express, Influx DB Cloud 2.0, Mongo DB w/ Mongoose, Twilio, React, React SVG Gauge, React Day-Picker, Date-FNS, Material UI</li>
                                        </ul>
                                        <h3 className='text-link code-text' id='capstone' onClick={this.handleModal}>VIDEO TOUR</h3>
                                        <br />
                                        <h4 className='code-title'>LINKS:</h4>
                                        <a target='_blank' rel="noopener noreferrer" href='https://github.com/JoshLDowns/ceres-greens-capstone'><h3 className='text-link code-text'>GITHUB</h3></a>
                                        <a target='_blank' rel="noopener noreferrer" href='http://ceres-greens-application.herokuapp.com/'><h3 className='text-link code-text'>HEROKU</h3></a>
                                    </div>
                                </div>
                                <div className='code-text-fade'></div>
                            </div>
                            <div className='code-image-wrapper right-cd'>
                                <img className='code-image' src='/images/ceres-greens.png' alt='Ceres Greens Dashboard' />
                            </div>
                        </div>
                        {/*Belt Blaster Content*/}
                        <div className='project'>
                            <div className='code-image-wrapper'>
                                <img className='code-image' src='/images/testshooter_9.gif' alt='Belt Blaster' />
                            </div>
                            <div className='code-text-wrapper'>
                                <div className='code-text-scroll'>
                                    <div className='inner-code-text'>
                                        <h3 className='code-title'>BELT BLASTER</h3>
                                        <p className='code-text'>8-Bit space shooter built in Pico-8</p>
                                        <ul>
                                            <li className='code-text'>Fight your way through endless waves of asteroids and turret style enemies</li>
                                            <li className='code-text'>Power up your scatter shot for an explosive attack!</li>
                                            <li className='code-text'>Destroying turrets gives you a chance at additional lives</li>
                                            <li className='code-text'>Use your arrow keys to move the ship</li>
                                            <li className='code-text'>Z fires your main laser, X fires your scatter shot</li>
                                        </ul>
                                        <h4 className='code-title'>LINKS:</h4>
                                        <a target='_blank' rel="noopener noreferrer" href='https://www.lexaloffle.com/bbs/?tid=37701'><h3 className='text-link code-text'>PLAY!</h3></a>
                                    </div>
                                </div>
                                <div className='code-text-fade'></div>
                            </div>
        ...
        return (
            <div id='video-modal' className='modal-load'>
                ...
                <div className='modal-video-wrapper'>
                    <iframe src="https://player.vimeo.com/video/414123397" width="740" height="416" frameBorder="0" allow="autoplay; fullscreen" allowFullScreen></iframe>
                </div>
            </div>
        )
    }

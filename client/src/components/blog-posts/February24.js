        ...
        <div className={props.className}>
            <div className='blog-post'>
                ...
                <div className='blog-img-wrapper'>
                    <img class='blog-img' src='./images/blog-img/buildStatesCodeSnip.png' alt='Code snippet' />
                </div>
                ...
                <div className='blog-img-wrapper'>
                    <img class='blog-img' src='./images/blog-img/detScoreCodeSnip.png' alt='Code snippet' />
                </div>
                ...
                <div className='blog-img-wrapper'>
                    <img class='blog-img' src='./images/blog-img/makeMoveCodeSnip.png' alt='Code snippet' />
                </div>
                ...
                <div className='blog-img-wrapper'>
                    <img class='blog-img' style={{width: '30%'}} src='./images/blog-img/ticTacToeBoardSample.png' alt='Tic Tac Toe Screenshot' />
                </div>

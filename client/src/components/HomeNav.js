...
class HomeNav extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            count: 0,
            imgAr: [<Link to={'/about'}><img src={about} id='/about' className='img-button' onClick={this.props.handleNavLink} alt='About Link' /></Link>,
            <Link to={'/code'}><img src={code} id='/code' className='img-button' alt='Code Link' onClick={this.props.handleNavLink} /></Link>,
            <Link to={'/art'}><img src={art} id='/art' className='img-button' onClick={this.props.handleNavLink} alt='Art Link' /></Link>,
            <Link to={'blog'}><img src={blog} id='/blog' className='img-button' alt='Blog Link' onClick={this.props.handleNavLink} /></Link>],
            centerLeftClass: '',
            rightCenterClass: '',

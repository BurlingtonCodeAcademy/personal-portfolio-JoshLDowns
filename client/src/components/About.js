            ...
            <div id='div-scroll' className={props.animationClass}>
                <div id='about'>
                    <div id='headshot-wrapper' className='about-image-wrapper'>
                        <img id='headshot' className='about-image' src='./images/headshot.png' alt='Josh Downs' />
                    </div>
                    <h1>HI, I'M JOSH</h1>
                    ...
                    <div id='family-wrapper' className='about-image-wrapper'>
                        <img id='family' className='about-image' src='./images/fam.png' alt='Josh and his family' />
                    </div>

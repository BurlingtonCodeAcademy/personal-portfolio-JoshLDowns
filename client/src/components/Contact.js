    ...
    return (
      <div id="main-div">
        ...
        <div id="div-scroll" className={this.props.animationClass}>
          <div id="contact-body">
            <h3>
              If you have any questions for me, are interested in working
              together, or just want to get in touch, fill out the form!
            </h3>
            <div id="contact-form">
              <form
                id="message-inputs"
            ...
            <div id="contact-images">
              <div className="contact-image-wrapper">
                <img
                  ...
                  id="https://github.com/JoshLDowns"
                  onClick={this.handleImageLink}
                  alt="Git Hub Link"
                />
              </div>
              <div className="contact-image-wrapper">
                <img
                  ...
                  className="contact-image"
                  id="https://www.linkedin.com/in/josh-l-downs/"
                  onClick={this.handleImageLink}
                  alt="LinkedIn Link"
                />
              </div>
              <div className="contact-image-wrapper">
                <img
                  ...
                  className="contact-image"
                  id="https://www.facebook.com/UltraDowny"
                  onClick={this.handleImageLink}
                  alt="Facebook Link"
                />
              </div>
